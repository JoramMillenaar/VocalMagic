...
from source.frequency_extractor import SimpleFrequencyExtractor
...
def parse_args():
    ...
    parser.add_argument(
        '--frequency-resolution', type=int, default=2,
...
def main():
    ...
    s = AudioModifierDecorator(
        stream=s,
        extractor=SimpleFrequencyExtractor(),
        frequency_resolution=args.frequency_resolution,
        manipulator=AutoTuneManipulator(NOTE_FREQUENCIES),
    )
